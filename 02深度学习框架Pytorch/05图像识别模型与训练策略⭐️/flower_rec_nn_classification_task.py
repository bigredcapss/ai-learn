...
# 02深度学习框架Pytorch/05图像识别模型与训练策略⭐️/flower_data
print(datasets.ImageFolder(os.path.join(data_dir, 'train')))
# 创建数据集和数据加载器
# 使用ImageFolder创建训练和验证数据集
...
# 设置模型名称为resnet，并启用特征提取模式（不更新预训练模型的参数）
